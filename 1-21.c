/* Excercise 1-21 in K&R
*  Benjamin Sadler, 02/07/20
*
*  Exercise Prompt: "Write a program entab that replaces 
*  strings of blanks with the minimum number of tabs and 
*  blanks to achieve the same spacing. Use the same stops 
*  as for detab . When either a tab or a single blank would 
